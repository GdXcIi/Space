...
We also declare what system module `logger` should implement to manage manage logs.
...
>
> The rest is just declarations so that system module `logger` can implement it.
